        ...
        switch(option){
          ...
          case "2":
            ...
            case "3":
              ...
              break;
              case "4":
                db.collection('companies').find({"founded_year" : 2004, "founded_month" : 2}, {_id: 0, name: 1}).toArray((error, result) => {
                  if (error) {
                    console.log(error);
                    rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                  } else {
                  ...
                  case "7":
                    ...
                    case "8":
                      ...
                      case "9":
                        ...
                        break;
                        case "10":
                          db.collection('companies').find({name : "Facebook"}, {_id: 0, products: 1}).toArray((error, result) => {
                            if (error) {
                              console.log(error);
                              rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                            } else {
