      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "3":
            db.collection('companies').count({
              ...
              if (error) {
                ...
                console.log(`there are ${count} companies founded in 2004`);
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu();
                });
              }
          ...
          case "5":
            ...
            db.collection('companies').find(query, fields, options).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu();
          ...
          case "10":
            db.collection('companies').find({
              ...
              if (error) {
                ...
                result[0].products.forEach(p => console.log(p.name));
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu();
                });
              }
