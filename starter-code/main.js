            ...
            rl.question('Type an option: ', (option) => {
                switch (option) {
                    ...
                    case "4":
                        ...
                        break;
                    case "5": // Duda, por que el sort aqui lo hace distinto que en compass?
                        db.collection('companies').find({ $and: [{ founded_year: 2004 }, { founded_month: { $gte: 4 } }, { founded_month: { $lte: 6 } }] }, { name: 1, _id: 0 }).sort( { founded_year: 1, founded_month: 1, founded_day: 1 } ).toArray((error, result) => {
                            if (error) {
                                console.log(error);
                                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                            } else {
                    ...
                    case "7":
                        ...
                        break;
                    case "8": // No me queda muy claro por qué los valores que son array los devuelve como [object] [object], no se si es normal o deberia devoler todo como en la bbdd
