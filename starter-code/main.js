          ...
          case "2":
            db.collection('companies').find({}, {name: 1, _id: 0}).toArray((error, result) => {
              if (error) {
                ...
                console.log(`There are ${result.length} items in the database.`);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              }
            })
            break;
          ...
          case "4":
            db.collection('companies').find({
              ...
              if (error) {
                ...
                console.log(`There are ${result.length} companies founded in February of 2004.`);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              }
            })
            break;
          case "5":
            db.collection('companies').find({
              ...
              if (error) {
                ...
                console.log(`There are ${result.length} companies founded in summer of 2004.`);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              }
            })
            break;
            ...
            db.collection('companies').find({"offices.city": "Barcelona"}, {name: 1, _id: 0}).toArray((error, result) => {
              if (error) {
                ...
                console.log(`There are ${result.length} companies with offices in Barcelona.`);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              }
            })
            break;
            ...
            db.collection('companies').find({
              ...
              , {"relationships.person.first_name": 1, "relationships.person.last_name": 1, "relationships.is_past": 1, _id: 0}).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
                console.log(`Facebook employee:`);
            ...
            db.collection('companies').find({
              ...
              if (error) {
                ...
                console.log(`Number of former facebook employees:`);
                var count = 0;
                for (let i = 0; i < result[0].relationships.length; i++) {
