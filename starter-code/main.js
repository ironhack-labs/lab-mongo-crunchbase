      ...
      rl.question('Type an option: ', (option) => {
        switch(option){
          ...
          case "2":
            ...
            break;
					case "3":
						db.collection(companies).find({founded_year: 2004},{name:1, founded_year:1, _id:0}).toArray((error,result) => {
							if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu();
                ...
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu();
						...
						break;
					case "4":
						db.collection(companies).find({founded_year: 2004, founded_month:2},{name:1, founded_year:1, founded_month:1, _id:0}).toArray((error,result) => {
						if (error) {
							console.log(error);
							rl.question(`\nType enter to continue: `, (answer) => {
								mainMenu();
