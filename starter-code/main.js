    ...
    function mainMenu() {
      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "2":
            //db.collection('companies').count({}, (result) => {
            //console.log(result)
            //});
          ...
          case "11":
            db.collection('companies').find({
              ...
              if (error) {
                ...
                //console.log(result[0].relationships.filter((e)=> !e.is_past))
                //result[0].relationships.forEach((e) => {
                //console.log(e.person.first_name + " " + e.person.last_name);
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu()
                });
              }
          ...
          case "14":
            db.collection('companies').find({
              "competitions.competitor.permalink": "facebook",
            }, {
              "name": 1,
              _id: 0
            }).toArray((error, result) => {
