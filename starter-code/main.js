    ...
    function mainMenu() {
      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "2":
            db.collection('companies').count('companies').toArray ((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu()
          ...
          case "5":
            db.collection('companies').find({founded_year: 2004, founded_month:4, founded_month: 5, found_month:6}, {name: 1, _id: 0}).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => {
                  mainMenu()
