          ...
          case "3":
            ...
            case "4":
              ...
              case "5":
                      ...
                      db.collection('companies').find({"founded_year": 2004} && {"founded_month": { $gt: 3 }} && {"founded_month": { $lt: 7 }}, {name: 1, _id: 0}).sort({"founded_day": -1}).toArray  ((error, result) => {
                      if (error) {
                      console.log(error);
                      rl.question(`\nType enter to continue: `, (answer) => { mainMenu(); });
                      } else {
                ...
                case "6":
                  ...
                  case "7":
                          ...
                          db.collection('companies').find({}, {name: 1, _id: 0} && {"relationships.person": 1, _id: 0}).sort({"number_of_employees": -1}).toArray  ((error, result) => {
                          if (error) {
                          console.log(error);
                          rl.question(`\nType enter to continue: `, (answer) => { mainMenu(); });
                          } else {
