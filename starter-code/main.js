...
mongoClient.connect(url, (error, db) => {
  if (error) {
    ...
    function pressEnter() {
      rl.question(`\nPress a key to continue : `, (answer) => {
        mainMenu()
      });
    }
      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          case "1":
            ...
            break;
          case "2":
            db.collection('companies').count((error, results) => {
              if (error) {
                console.log(error);
                pressEnter();
              } else {
                console.log(`${results} companies`);
                pressEnter();
              }
            });
            break;
            ...
            db.collection('companies').find({
              ...
              .count((error, results) => {
                if (error) {
                  ...
                  console.log(`${results} companies founded in 2004`);
                  pressEnter();
                }
              });
            break;
          ...
          case "9":
            db.collection('companies').findOne({
              ...
              if (error) {
                ...
                console.log(`${result.number_of_employees} employees`);
                pressEnter();
              }
            })
            break;
