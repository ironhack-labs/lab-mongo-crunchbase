    ...
    rl.question('Type an option: ', (option) => {
      ...
      case '5':
        db.collection('companies').find(
          {founded_year: 2004, founded_month: { $gt: 3, $lt: 7 } }, {name: 1, _id: 0}
        ).sort(
          {founded_day: 1, founded_month: 1}
      ...
      case '6':
        ...
        break;
      case '7':
        db.collection('companies').find({}, {name: 1, _id: 0}, {name: 1, _id: 0}).limit(10).sort(
