        ...
        switch(option){
          ...
          case "4":
            ...
            {name: 1, _id:0 }).toArray((error, result) => {
              ...
              break;
          case "5":
            db.collection('companies').find({ "founded_year": 2004, "founded_month":
              { $gte: 4, $lte: 6 } }, {name: 1, _id:0 })
            ...
            break;
          case "6":
            db.collection('companies').find( { offices: { $elemMatch: { city: 'Barcelona' } } },
              { name: 1, _id: 0 })
              .toArray((error, result) => {
              if (error) {
                console.log(error);
                ...
                console.log(result); rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              }
            });
            break;
          case "7":
            ...
            break;
          case "8":
            db.collection('companies').find({name : 'Facebook'}, { _id: 0})
            .toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
          ...
          case "9":
            ...
            break;
          case "10":
            db.collection('companies').find({name : 'Facebook'}, { products:1, _id: 0})
            .toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
