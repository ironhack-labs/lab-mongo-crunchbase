        ...
        function mainMenu() {
            ...
            rl.question('Type an option: ', (option) => {
                switch (option) {
                    ...
                    case "4":
                        db.collection('companies').find({ $and: [{ "founded_year": "2004" },{"founded_month": 2}] }, {name: 1, _id: 0 }).count((error, result) => {
                        if (error) {
                            console.log(error);
                            rl.question(`\nType enter to continue: `, (answer) => {
                                mainMenu()
                    ...
                    case "5":
                        db.collection('companies').find({ $and: [{"founded_year": 2004}, { $or: [{"founded_month": 4}, {"founded_month": 5}, {"founded_month": 6}]}]}, {name: 1, _id: 0 }).count((error, result) => {
                        if (error) {
                            console.log(error);
                            rl.question(`\nType enter to continue: `, (answer) => {
                                mainMenu()
                    ...
                    case "11":
                        ...
                        if (error) {
                            ...
                            result[0].relationships.forEach((elm) => {if(elm.is_past) { console.log(elm.person)}})
                            rl.question(`\nType enter to continue: `, (answer) => {
                                mainMenu()
                            });
                        }
                    ...
                    case "14":
                        db.collection('companies').find({"competitions.competitor.name": "Facebook"}, { name: 1, _id: 0, }).toArray((error, result) => {
                        if (error) {
                            console.log(error);
                            rl.question(`\nType enter to continue: `, (answer) => {
                                mainMenu()
                    ...
                    case "16":
                      ...
                      case "17":
                        db.collection('companies').find({"offices.city": "London"}, {name: 1, _id: 0, offices: 1}).toArray((error, result) => {
                        if (error) {
                            console.log(error);
                            rl.question(`\nType enter to continue: `, (answer) => {
                                mainMenu()
                            ...
                            result[0].offices.forEach((offices) => {console.log(offices.city); });
                            rl.question(`\nType enter to continue: `, (answer) => {
                                mainMenu()
                            });
                        }
                    ...
                    case "18":
                        db.collection('companies').find({ $and: [{ "tag_list": { $regex: "social-network" } },{"founded_year": {$gte: 2002}}, {"founded_year": {$lte: 2016}}, {"offices.city": "New York"}]}, { name: 1, _id: 0, }).count((error, result) => {
                        if (error) {
                            console.log(error);
                            rl.question(`\nType enter to continue: `, (answer) => {
                                mainMenu()
