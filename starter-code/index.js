      ...
      function mainMenu(){
        ...
        rl.question('Type an option: ', (option) => {
          switch(option){
            ...
            // db.collection('companies').find( {$and: [{"founded_year": {$eq: 2004}}, {"founded_month": {$gte: 4}}, {"founded_month": {$lte: 6}} ]})
            db.collection('companies')
            .find({$and: [{"founded_year": {$eq: 2004}}, {"founded_month": {$gte: 4}}, {"founded_month": {$lte: 6}} ]}, {name: 1, founded_day: 1, founded_month:1, founded_year:1, _id: 0})
            ...
            break;
            case "7":
            db.collection('companies').find({number_of_employees: {$gte: 10000}}, {name: 1, number_of_employees: 1, _id: 0})
