        ...
        function mainMenu(){
          ...
          rl.question('Type an option: ', (option) => {
            switch(option){
              ...
              case "4":
                db.collection('companies').find({"founded_year": 2004, "founded_month": 2}, {"name": 1, _id: 0}).sort((error, result) => {
                  if (error) {
                    console.log(error);
                    rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                  } else {
              ...
              case "5":
                db.collection('companies').find({"founded_year": 2004,  $and: [ {"founded_month": {$gt: 3}}, {"founded_month":{$lt:7} } ] }, {name: 1, "founded_month": 1, _id: 0}).sort({"founded_month": 1}).toArray((error, result) => {
                  if (error) {
                    console.log(error);
                    rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
                  } else {
